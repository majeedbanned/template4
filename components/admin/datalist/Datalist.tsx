"use client";
import { columns } from "@/app/[lang]/(admin)/admin/students/components/columns";
import { DataTable } from "@/app/[lang]/(admin)/admin/students/components/data-table";
...
export default function Datalist({}: Props) {
  ...
  const {
    ...
    isLoading,
    mutate,
  } = useSWR<UserProps[]>(`/api/user?search=${query}`, fetcher);
