...
export default function TaskCard6({}: Props) {
  return (
    <Card className="flex dark:bg-[#121415] border-0 p-4 gap-2 flex-col rounded-2xl shadow-md justify-start   h-auto">
      <div className="  w-full  flex flex-row gap-2 ">
        ...
        >
          <span className="text-[13px] font-semibold ">Joint call</span>
        </Button>
        <Button
          variant={"outline"}
      ...
      <div>
        ...
        <Card className="flex gap-1 flex-row items-center p-2 px-2 border-0 dark:bg-[#1e1f21] bg-[#f7f8fa] text-sm text-gray-500 dark:text-white">
          <Avatar className="border-[3px]  border-white dark:border-[#0f172b]">
            <AvatarImage src="https://i.pravatar.cc/301" alt="@shadcn" />
            <AvatarFallback>CN</AvatarFallback>
          </Avatar>
          <span className="text-sm font-bold text-blue-500">Ivan Makaev</span>

          <Button
            variant={"secondary"}
            className="ltr:ml-auto rtl:mr-auto p-0 w-10 shadow-lg shadow-[#fbd99a] h-10  rounded-full  bg-gradient-to-b from-[#fbd99a] to-[#fab432]"
          >
            <MicrophoneIcon className="w-4 h-4 text-white"></MicrophoneIcon>
          </Button>
          <Button
            variant={"secondary"}
            className=" p-0 w-10 shadow-lg shadow-[#b2eca9] h-10  rounded-full  bg-gradient-to-b from-[#b2eca9] to-[#4ae054]"
          >
            <PhoneIcon className="w-4 h-4 text-white"></PhoneIcon>
          </Button>

          <Button
            variant={"secondary"}
            className=" p-0 w-10 shadow-lg shadow-[#f39dbf] h-10  rounded-full  bg-gradient-to-b from-[#f39dbf] to-[#e4337b]"
          >
            <PhoneXMarkIcon className="w-4 h-4 text-white"></PhoneXMarkIcon>
          </Button>
        </Card>
      </div>
      <div>
