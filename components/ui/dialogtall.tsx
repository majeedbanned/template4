...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    className={cn(
      "fixed inset-0 z-50 bg-white/70 dark:bg-black/70 backdrop-blur-sm data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 flex overflow-y-auto flex-row items-start justify-center",
      className
    )}
    {...props}
  />
