...
export const DeleteOwnerModal = ({
  ...
  const onSubmit: SubmitHandler<FieldValues> = async (data) => {
    ...
    const promise = () =>
      new Promise((resolve) => {
        setIsLoading(true);
        fetch(`/api/owner/${_DeleteOwnerModal.editID}`, {
          method: "DELETE",
  ...
  return (
    <Modal
      disabled={isLoading}
      isOpen={_DeleteOwnerModal.isOpen}
      title="حذف اطلاعات"
      // "افزودن واحد"
      actionLabel="حذف"
      actionLabelVariant="destructive"
      secondaryActionLabel="انصراف"
      secondaryAction={_DeleteOwnerModal.onClose}
      onClose={_DeleteOwnerModal.onClose}
...
const useDeleteOwnerModal = create<DeleteOwnerModal>((set) => ({
  isOpen: false,
  editID: "",
...
export default useDeleteOwnerModal;
